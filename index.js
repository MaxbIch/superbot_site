(function () {
    ...
    function addStyles() {
        ...
        style.textContent = '.exchange-calculator{display:flex;flex-direction:column;align-items:stretch;gap:0;max-width:760px;padding:30px;background:rgba(255,255,255,.96);border:1px solid #e5ebe7;border-radius:24px;box-shadow:0 18px 50px rgba(30,55,42,.09)}.bot-calculator__row{display:grid;grid-template-columns:minmax(150px,.75fr) minmax(220px,1fr);gap:14px;align-items:end}.bot-calculator__currency-wrap{position:relative}.bot-calculator__currency{width:100%;height:56px;border:1px solid #dfe5e1;border-radius:15px;background:#fff;padding:0 16px;display:flex;align-items:center;gap:9px;font:inherit;font-size:16px;cursor:pointer;color:#1f2a25;transition:border-color .2s,box-shadow .2s}.bot-calculator__currency:hover,.bot-calculator__currency:focus{border-color:#4caf7a;box-shadow:0 0 0 4px rgba(76,175,122,.1);outline:none}.bot-calculator__currency span{margin-left:auto;color:#7b8781}.bot-calculator__dropdown{position:absolute;z-index:20;top:64px;left:0;right:0;background:#fff;border:1px solid #dfe5e1;border-radius:15px;padding:6px;box-shadow:0 16px 40px rgba(25,40,32,.16);display:none}.bot-calculator__dropdown.is-open{display:block}.bot-currency{width:100%;border:0;background:transparent;border-radius:10px;padding:11px 12px;display:block;font:inherit;cursor:pointer;text-align:left}.bot-currency:hover{background:#f1f7f3}.bot-calculator__amount-wrap{display:flex;flex-direction:column;gap:7px}.bot-calculator__amount-wrap label{font-size:12px;font-weight:700;color:#6d7772;text-transform:uppercase;letter-spacing:.05em}.bot-calculator__amount-wrap input{width:100%;height:56px;border:1px solid #dfe5e1;border-radius:15px;padding:0 16px;font:inherit;font-size:19px;font-weight:600;outline:none;background:#fff;transition:border-color .2s,box-shadow .2s}.bot-calculator__amount-wrap input:focus{border-color:#4caf7a;box-shadow:0 0 0 4px rgba(76,175,122,.1)}.bot-calculator__result{margin-top:18px;padding:20px 22px;border-radius:18px;background:linear-gradient(135deg,#eef8f2,#f7fbf8);border:1px solid rgba(76,175,122,.16)}.bot-calculator__result-label{font-size:12px;font-weight:700;color:#6d7772;text-transform:uppercase;letter-spacing:.05em;margin-bottom:5px}.bot-calculator__result-value{font-size:30px;line-height:1.15;font-weight:800;color:#2f8e5e;letter-spacing:-.02em}.bot-calculator__rates{margin-top:10px;padding:0 4px}.bot-rate-line{display:flex;justify-content:space-between;align-items:center;padding:12px 2px;border-bottom:1px solid #edf0ee;font-size:14px;color:#56625c}.bot-rate-line:last-child{border-bottom:0}.bot-rate-line strong{color:#24342b;font-size:15px}.bot-calculator__order{margin-top:18px;min-height:54px;padding:0 20px;border-radius:15px;background:#4caf7a;color:#fff;display:flex;align-items:center;justify-content:center;gap:10px;text-decoration:none;font-size:15px;font-weight:800;box-shadow:0 10px 24px rgba(76,175,122,.22);transition:transform .2s,background .2s,box-shadow .2s}.bot-calculator__order:hover{background:#3d9a68;transform:translateY(-2px);box-shadow:0 14px 30px rgba(76,175,122,.28)}.bot-calculator__order b{font-size:20px;line-height:1}.section--exchange .exchange-note{display:none}.tour-mini-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:22px}.tour-mini-card{display:block;overflow:hidden;border-radius:20px;background:#fff;box-shadow:0 10px 30px rgba(28,45,36,.09);text-decoration:none;color:inherit;transition:transform .25s ease,box-shadow .25s ease}.tour-mini-card:hover{transform:translateY(-5px);box-shadow:0 18px 40px rgba(28,45,36,.14)}.tour-mini-card__image{display:block;height:190px;overflow:hidden}.tour-mini-card__image img{width:100%;height:100%;object-fit:cover;display:block;transition:transform .4s ease}.tour-mini-card:hover img{transform:scale(1.04)}.tour-mini-card__body{display:flex;flex-direction:column;padding:18px 20px 20px}.tour-mini-card__body strong{font-size:24px;font-weight:800}.tour-mini-card__body span{margin-top:4px;font-size:13px;color:#4caf7a;font-weight:700}.tour-mini-card__body small{margin-top:10px;min-height:58px;font-size:13px;line-height:1.55;color:#6d7772}.tour-mini-card__body em{margin-top:15px;font-size:14px;font-style:normal;font-weight:800;color:#2f8e5e}@media(max-width:800px){.tour-mini-grid{grid-template-columns:1fr}.tour-mini-card{display:grid;grid-template-columns:150px 1fr}.tour-mini-card__image{height:100%;min-height:150px}.tour-mini-card__body{padding:15px}.tour-mini-card__body small{min-height:0}.bot-calculator__row{grid-template-columns:1fr}.exchange-calculator{padding:22px}.bot-calculator__result-value{font-size:26px}}@media(max-width:480px){.tour-mini-card{display:block}.tour-mini-card__image{height:180px}.bot-calculator__result{padding:18px}.bot-calculator__result-value{font-size:24px}}';
